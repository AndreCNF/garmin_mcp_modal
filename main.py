...
def endpoint():
    ...
    # Prefer volume tokens over the bootstrap env var so a re-bootstrap can
    # update tokens without a redeploy. `reload()` picks up any commits that
    # happened after this container's volume was mounted.
